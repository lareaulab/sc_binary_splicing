...
W_chen = get_distance_matrix(chen_pca_clust, k=22)
...
pgamma_chen.to_csv('pgamma_chen_sqrt.tab', sep='\t', header=True, index=True)
...
W_trapnell = get_distance_matrix(trapnell_pca_clust, k=15)
...
pgamma_trapnell.to_csv('pgamma_trapnell_sqrt.tab', sep='\t', header=True, index=True)
...
W_song = get_distance_matrix(song_pca_clust, k=14)
...
pgamma_song.to_csv('pgamma_song_sqrt.tab', sep='\t', header=True, index=True)
