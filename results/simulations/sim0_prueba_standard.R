...
gene_len_half <- c(sample(c(1:500),500,replace=FALSE)+1000,
              sample(c(1:500),500,replace=FALSE)+1000,
              sample(c(1:500),500,replace=FALSE)+1000)

#gene_len_half <- sample(c(1:1500),1500,replace=FALSE)+500
gene_len <- c(gene_len_half, gene_len_half)
...
#for (i in 1:1500) {
#  PSI <- 0.5#rbeta(300, alpha_param[i], beta_param[i])
